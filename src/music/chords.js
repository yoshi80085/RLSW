...
//
// Projectile opening band: original harmonic weights rebased with ceil((value-1)/2), 1–5.
// Rank and affinity still select the chord; raw note count never selects dice.
// Historical weighting before rebasing (THEORY_REWRITE_LOG Task A):
...
export const CHORD_TEMPLATES = [
  ...
  { id:'dom13', label:'Dominant 13',  ivals:[0,4,7,10,2,9], rank:8, drive:5, sustain:4 }, // drive-lean
  { id:'min11', label:'Minor 11',     ivals:[0,3,7,10,2,5], rank:8, drive:4,  sustain:5 },// sustain-lean
  // 5-note (base 8)
  { id:'dom9',  label:'Dominant 9',   ivals:[0,4,7,10,2], rank:7, drive:4, sustain:3 },  // drive-lean
  { id:'min9',  label:'Minor 9',      ivals:[0,3,7,10,2], rank:7, drive:3, sustain:4 },  // sustain-lean
  // 4-note (base 7)
  { id:'dim7',  label:'Diminished 7', ivals:[0,3,6,9],    rank:6, drive:4, sustain:3 },  // drive-lean
  { id:'dom7',  label:'Dominant 7',   ivals:[0,4,7,10],   rank:6, drive:4, sustain:3 },  // drive-lean
  { id:'maj7',  label:'Major 7',      ivals:[0,4,7,11],   rank:6, drive:3, sustain:4 },  // sustain-lean
  { id:'min7',  label:'Minor 7',      ivals:[0,3,7,10],   rank:6, drive:3, sustain:4 },  // sustain-lean
  { id:'m7b5',  label:'Half-dim 7',   ivals:[0,3,6,10],   rank:6, drive:4, sustain:3 },  // drive-lean
  // 3-note (base 6)
  { id:'dim',   label:'Diminished',   ivals:[0,3,6],      rank:5, drive:3, sustain:2 },  // drive-lean
  { id:'aug',   label:'Augmented',    ivals:[0,4,8],      rank:5, drive:3, sustain:2 },  // drive-lean
  { id:'maj',   label:'Major triad',  ivals:[0,4,7],      rank:4, drive:2, sustain:3 },  // sustain-lean
  { id:'min',   label:'Minor triad',  ivals:[0,3,7],      rank:4, drive:2, sustain:3 },  // sustain-lean
  { id:'sus2',  label:'Sus2',         ivals:[0,2,7],      rank:3, drive:3, sustain:3 },  // neutral
  { id:'sus4',  label:'Sus4',         ivals:[0,5,7],      rank:3, drive:3, sustain:3 },  // neutral
  // 2-note (base 5)
  { id:'power', label:'Power chord',  ivals:[0,7],        rank:2, drive:2, sustain:2 },  // neutral
];

const SINGLE  = { id:'single',  label:'Single note',  drive:1, sustain:1 };
const CLUSTER = { id:'cluster', label:'Tone cluster', drive:1, sustain:1 };  // was drive:3, sustain:1
