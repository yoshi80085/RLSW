...
| `melodyPayout.js` | — | `melodyPayoutFor`, `roninMelodyPayout`, `CLEAN_NOTE_DB`, `CLEAN_STREAK_DB` | 🎵 Pure three-layer payout reading: clean-note dividend/streak, harmonic final, and the Spirit’s fan structure. |
