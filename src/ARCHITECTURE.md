...
| `melodyCommit.js` | 707 | `commitMelodyEconomy`, `positionFanGain`, `deedFanGain`, `performanceFanGain`, `SPEED_CAP`, `COLOR_PAYOUT_CAP`, `MIC_VOICE_ROLL_DIE`, `CLIENT_OWNED` | 🎵 What a committed melody pays. `CLIENT_OWNED` names the pieces still living in the monolith — read it before assuming a payout is here. |
