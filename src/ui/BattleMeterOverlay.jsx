                  ...
                  <div style={{display:'flex', gap:6, justifyContent:'center', margin:'6px 0 2px'}}>
                    {Object.entries(RIFF_FALL_DIFFICULTY).map(([k, d]) => (
                      <button key={k} onClick={() => setRiffDifficulty?.(k)}
                        title={d.blurb} style={{
                        cursor:'pointer', fontFamily:"'Saira Stencil One',sans-serif", fontSize:8, letterSpacing:1, padding:'3px 8px', borderRadius:6,
              ...
              {phase === 'riff_play' && (
                <div style={{...cardBase(noteColor), maxWidth:'min(1200px, 94vw)',
                  ...
                  {battleState.riffRun ? (
                    <div style={{display:'flex', justifyContent:'center', margin:'2px 0'}}>
                      <RiffHighway
                        ...
                        showNums={RIFF_FALL_DIFFICULTY[riffDifficulty]?.showLabels ?? true}
                      />
                    </div>
                  ) : (
                  ...
                  <div style={{fontSize:9, letterSpacing:2, height:14, marginTop:6,
                    ...
                    {(!isAtkTurn && battleState.defGhosts)
                      ? '🎴 GHOST BARRAGE — EVERY NOTE DEMANDS BOTH STRINGS'
                      : 'HIT THE STRING NUMBER AS THE GEM CROSSES THE BRIDGE — HOLD TO SUSTAIN, ↑↓ TO BEND'}
                  </div>
          ...
          <div style={{
            ...
            {skipBattleIntro && ['enter_attacker','flash_drive','pick_drive_slide','enter_defender','flash_sustain','pick_sustain_slide'].includes(phase) && (
              <button onClick={skipBattleIntro}
                style={{position:'absolute', top:14, right:16, zIndex:20, cursor:'pointer',
                  fontFamily:"'Saira Stencil One',sans-serif", fontSize:10, letterSpacing:1,
            ...
            <div style={{display:'flex', alignItems:'center', justifyContent:'center',
              ...
              <div style={{
                  ...
                  <div
                    ...
                    {atkSpinning && (
                      <div style={{
                        ...
                        letterSpacing:3, fontFamily:"'Saira Stencil One',sans-serif",
                ...
                <div style={{fontSize:8, color:attacker?.color ?? '#ff4444', letterSpacing:2, marginTop:6,
                  fontFamily:"'Saira Stencil One',sans-serif", textTransform:'uppercase'}}>{attacker?.name?.split(' ')[0]}</div>
              </div>
            ...
            {moveFlash && (
              <div key={`move-${phase}-${moveFlash.text}`} style={{
                ...
                <div style={{
                  fontFamily:"'Saira Stencil One',sans-serif", fontWeight:900,
              ...
              <div key="result-banner" style={{
                ...
                <button
                  ...
                  style={{
                    ...
                    color: attackerWon ? (attacker?.color ?? '#ff4444') : (defender?.color ?? '#00ccff'),
                    fontSize:11, letterSpacing:3, fontFamily:"'Saira Stencil One',sans-serif",
                    cursor:'pointer',
