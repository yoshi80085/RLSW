          ...
          <div style={{
            ...
            <div style={{display:'flex', alignItems:'flex-end', justifyContent:'center',
              ...
              <div style={{
                ...
                {/* 🎸 GEAR PROP — the attacker's owned PA gear, animated by their feet */}
                {hasAnyGear && (
              ...
              <div style={{position:'relative', flexShrink:0, zIndex:2}}>
                ...
                <svg viewBox={`0 0 ${METER_W} ${METER_H}`}
                  ...
                  {/* ATK Die slot — SVG background rect sized to the real art box */}
                  <rect x={ATK_SQ_X-SQ_W/2} y={ATK_SQ_Y-SQ_H/2} width={SQ_W} height={SQ_H} rx={12}
                    fill="#040608" stroke={showAtkDie ? (attacker?.color ?? '#ff4444') : '#1a2240'}
                    strokeWidth={showAtkDie ? 2 : 1} opacity={0.6}/>

                  {/* DEF Die slot — SVG background rect sized to the real art box */}
                  <rect x={DEF_SQ_X-SQ_W/2} y={DEF_SQ_Y-SQ_H/2} width={SQ_W} height={SQ_H} rx={12}
                ...
                {showAtkDie && (
                  <div
                    ...
                    style={{
                      position:'absolute',
                      // Center the die within the box at (ATK_SQ_X, ATK_SQ_Y)
